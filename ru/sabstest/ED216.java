...
public class ED216 implements Comparable<ED216> {
	...
	payer = new Client();
	payer.readED((Element) doc.getElementsByTagNameNS("*", "ShortPayer")
		.item(0));
	payee = new Client();
	payee.readED((Element) doc.getElementsByTagNameNS("*", "ShortPayee")
		.item(0));
