...
public class ErrorCode {
	...
	case 41:
	    ...
	    cd = (cd == 10) ? 0 : cd;
	    pd.payer.personalAcc = pd.payer.personalAcc.substring(0, 8)
		    + Integer.toString(cd) + pd.payer.personalAcc.substring(9);
	    break;
	case 42:
	...
	case 45:
	    ...
	    cd = (cd == 10) ? 0 : cd;
	    pd.payee.personalAcc = pd.payee.personalAcc.substring(0, 8)
		    + Integer.toString(cd) + pd.payee.personalAcc.substring(9);
	    break;
	case 46:
	...
	case 53:
	    ...
	    break;
	case 54:
	    pd.tax = new DepartmentalInfo("a", "18210302011011000110", "456",
		    "8", "90", "12", "34", "56");
	    break;
	case 55:
	    pd.tax = new DepartmentalInfo("1", "18210302011011000110", "456",
		    "8", "90", "12", "34", "56");
	    pd.payer.kpp = "";
	    break;
	case 56:
	    ...
	    break;
	case 57:
	    pd.tax = new DepartmentalInfo("1", "", "456", "8", "90", "12",
		    "34", "56");
	    break;
	case 58:
	    pd.tax = new DepartmentalInfo("1", "18210302011011000110", "", "8",
		    "90", "12", "34", "56");
	    break;
	case 59:
	    pd.tax = new DepartmentalInfo("1", "18210302011011000110", "456",
