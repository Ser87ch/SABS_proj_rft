...
public class ED103 extends PaymentDocument {
	...
	public void insertIntoDbUfebs(int idPacet, int pEDNo, Date pacDate, String pAuthor, String filename) 
	{
		...
		try
		{
			...
			DB.toString(chargeOffDate) + ", " + DB.toString(receiptDateCollectBank) + ",  " + DB.toString(paytCondition) + ", " + DB.toString(tax.drawerStatus) + ", " + DB.toString(payer.kpp) + ", " + DB.toString(payee.kpp) + ", " + DB.toString(tax.cbc) + ", " + DB.toString(tax.okato) + ", " + DB.toString(tax.paytReason) + ",\r\n" + 
	...
	public void insertIntoDbVer(int idPacet, String filename) 
	{
		...
		try
		{
			...
			"VALUES(" + DB.toString(idPacet) + ", null,\r\n" + 
			"2, null, 0, 0, " + DB.toString(type) + "," + DB.toString(edNo) + ", " + DB.toString(edDate) + ", " + DB.toString(edAuthor) + ",\r\n" + 
			"null, null, null,\r\n" + 
