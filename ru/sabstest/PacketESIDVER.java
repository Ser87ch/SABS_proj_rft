 ...
 * 
 */
public class PacketESIDVER extends Packet implements Generate<PacketEPD>,
	ReadED {
	...
	public static void readXML(String src) {
		...
		eList.add(new Code(bic.getFirstChild().getNodeValue(), bic
			.getAttribute("ResultCode")));
	    }
